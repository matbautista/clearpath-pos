...
async function renderPosView(container) {
  ...
  slots.forEach((t) => {
    ...
    // by an admin/manager, who aren't required to have one at all. Either
    // way there's no shift claiming it yet, so the label stays neutral
    // rather than assuming a hand-off happened.
